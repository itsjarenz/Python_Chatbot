from BasketballJarence.NBA_API import *  # importing all the code from NBA_API file and running it
from BasketballJarence.Extra_Effects_For_Me import *  # importing all the code from Extra_Effects_For_Me file and running it
from BasketballJarence.sqlDB import *  # importing all the code from sqlDB file and running it
...
print()
# say("Welcome to NBA Basketball Chat-Bot!") # JAzzy this is bad code always put code into functions ( you are overwriteing the SportTalkBot File)
...
def BasketBall():
    ...
    while True:
        ...
        if userInput == "exit":
            ...
            SportBot.SportTalk()
            # Code add to go back to the main menu  by Ibrahim Waheed
        else:
            say("I did not understand what you said, rephrase or say something else.")
...
# Jarence had to change main to Basketball